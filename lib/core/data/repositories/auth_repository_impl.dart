...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<Either<Failure, AuthSession>> signInWithEmail(
    ...
    try {
      ...
      return Left(ServerFailure('Failed to sign in with email', 500));
    }
  }
  ...
  Future<Either<Failure, AuthSession>> signUpWithEmail(
    ...
    try {
      ...
      return Left(ServerFailure('Failed to sign up with email', 500));
    }
  }
  ...
  Future<Either<Failure, AuthSession>> signInWithGoogle() async {
    try {
      ...
      return Left(ServerFailure('Failed to sign in with Google', 500));
    }
  }
  ...
  Future<Either<Failure, AuthSession>> signInWithApple() async {
    try {
      ...
      return Left(ServerFailure('Failed to sign in with Apple', 500));
    }
  }
  ...
  Future<Either<Failure, void>> signOut() async {
    try {
      ...
      return Left(ServerFailure('Failed to sign out', 500));
    }
  }
  ...
  Future<Either<Failure, User?>> getCurrentUser() async {
    try {
      ...
      return Left(ServerFailure('Failed to get current user', 500));
    }
  }
  ...
  Future<Either<Failure, AuthSession?>> getCurrentSession() async {
    try {
      ...
      return Left(ServerFailure('Failed to get current session', 500));
    }
  }
  ...
  Future<Either<Failure, void>> sendPasswordResetEmail(String email) async {
    try {
      ...
      return Left(ServerFailure('Failed to send password reset email', 500));
    }
  }
  ...
  Future<Either<Failure, AuthSession>> refreshSession() async {
    try {
      ...
      return Left(ServerFailure('Failed to refresh session', 500));
    }
  }

      ...
      child: GridView.count(
        ...
        children: [
          ...
          _buildStatsCard(
            ...
            icon: Icons.inbox,
            color: Colors.blue,
            subtitle: 'بلاغات مستلمة',
          ),
          _buildStatsCard(
            context,
            title: 'قيد المراجعة',
            value: stats.underReviewReports.toString(),
            icon: Icons.search,
            color: Colors.orange,
            subtitle: 'قيد المراجعة حالياً',
          ),
          _buildStatsCard(
            context,
            title: 'تحقق من البيانات',
            value: stats.dataVerificationReports.toString(),
            icon: Icons.verified,
            color: Colors.purple,
            subtitle: 'في مرحلة التحقق',
          ),
          _buildStatsCard(
            context,
            title: 'تم اتخاذ إجراء',
            value: stats.actionTakenReports.toString(),
            icon: Icons.done_all,
            color: Colors.teal,
            subtitle: 'تم اتخاذ إجراء',
          ),
          _buildStatsCard(
            context,
            title: 'مكتملة',
      ...
      children: [
        ...
        Expanded(
          child: _buildQuickStat(
            context,
            'معدل الإكمال',
            '${((stats.completedReports / stats.totalReports) * 100).toStringAsFixed(1)}%',
            Icons.trending_up,
            Colors.orange,
          ),
        ),
